...
class page_two_dark extends StatefulWidget {
  final bool idioma;
  const page_two_dark({super.key, required this.idioma});

  @override
  State<page_two_dark> createState() => _page_two_darkState();
}

// ignore: camel_case_types
class _page_two_darkState extends State<page_two_dark> {
  bool idioma = false;
  ...
  @override
  void didUpdateWidget(covariant page_two_dark oldWidget) {
                            ...
                            children: [
                              ...
                              SizedBox(
                                ...
                                child: Image.asset(idioma
                                    ? 'assets/texto_02_dark.png'
                                    : 'assets/texto_02_dark_br.png'),
                              )
                            ],
                          ),
